...
internal class LoginViewModelTest {
    ...
    @Test
    fun `given login is called when collect state then isLoading is true during operation`() = runTest(testDispatcher) {
    ...
    @Test
    fun `given invalid user credentials when login should send error event`() = runTest(testDispatcher) {
