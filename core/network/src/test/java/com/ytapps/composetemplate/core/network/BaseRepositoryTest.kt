...
class BaseRepositoryTest {
    ...
    @Test
    fun `given successful response with body then return Success with data`() =
        runTest {
    ...
    @Test
    fun `given successful response with null body then return Error`() =
        runTest {
    ...
    @Test
    fun `given 401 response then return Unauthorized error`() =
        runTest {
            val response =
    ...
    @Test
    fun `given 403 response then return Forbidden error`() =
        runTest {
            val response =
                Response.error<String>(
                    403,
    ...
    @Test
    fun `given 404 response then return Resource not found error`() =
        runTest {
            val response =
                Response.error<String>(
                    404,
    ...
    @Test
    fun `given 500 response then return Server error`() =
        runTest {
            val response =
                Response.error<String>(
                    500,
    ...
    @Test
    fun `given IOException when calling API then return Error`() =
        runTest {
            val result =
                repository.safeCall<String> {
    ...
    @Test
    fun `given HttpException when calling API then return Error`() =
        runTest {
            val errorResponse =
                Response.error<String>(
                    400,
    ...
    @Test
    fun `given custom error body then return error with body message`() =
        runTest {
            val response =
                Response.error<String>(
                    422,
